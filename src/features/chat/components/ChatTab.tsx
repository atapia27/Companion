...
export function ChatTab({ processedContent, onStartChat, onSwitchToContext }: ChatTabProps) {
  return (
    <div className="text-center max-w-3xl mx-auto">
      ...
      {processedContent.length === 0 ? (
        ...
        <button
          onClick={onStartChat}
          className="bg-gradient-to-r from-neutralharmony-secondary-500 to-neutralharmony-secondary-600 hover:from-neutralharmony-secondary-600 hover:to-neutralharmony-secondary-700 text-neutralharmony-primary-900 px-10 py-4 rounded-xl text-xl font-bold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
        >
          Start Chat
        </button>
      )}
