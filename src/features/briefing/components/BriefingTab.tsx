...
export function BriefingTab({ processedContent, onGenerateBriefing, onSwitchToContext }: BriefingTabProps) {
  return (
    <div className="text-center max-w-3xl mx-auto">
      ...
      {processedContent.length === 0 ? (
        ...
        <button
          ...
          className="bg-gradient-to-r from-neutralharmony-tertiary-500 to-neutralharmony-tertiary-600 hover:from-neutralharmony-tertiary-600 hover:to-neutralharmony-tertiary-700 text-neutralharmony-primary-900 px-10 py-4 rounded-xl text-xl font-bold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
        >
          Generate Briefing
        </button>
      )}
